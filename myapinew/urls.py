...
router.register(r'noBrokerCommRent', views.noBrokerCommRent)
router.register(r'noBrokerCommSale', views.noBrokerCommSale)
router.register(r'noBrokerPg', views.noBrokerPg)
